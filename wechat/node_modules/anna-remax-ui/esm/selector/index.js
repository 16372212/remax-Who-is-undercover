...
var Selector = function Selector(props) {
  ...
  return /*#__PURE__*/React.createElement(View, {
    ...
    return /*#__PURE__*/React.createElement(View, {
      key: option.key,
      className: classNames((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-option"), true), _defineProperty(_classNames, "".concat(prefixCls, "-active"), activeParent === option.key), _classNames)),
      onTap: function onTap() {
        handleClickParentOption(option);
      }
    }, option.value, activeParent === option.key && index !== 0 ? /*#__PURE__*/React.createElement(View, {
      className: "".concat(prefixCls, "-option-rounded_top")
    }, /*#__PURE__*/React.createElement(View, {
      className: "".concat(prefixCls, "-option-rounded_top-circle")
    })) : null, activeParent === option.key ? /*#__PURE__*/React.createElement(View, {
    ...
    return /*#__PURE__*/React.createElement(View, {
      key: option.key,
      className: classNames((_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-option"), true), _defineProperty(_classNames2, "".concat(prefixCls, "-active"), (value === null || value === void 0 ? void 0 : value[1]) === option.key), _classNames2)),
      onTap: function onTap() {
