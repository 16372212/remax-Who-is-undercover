...
var Selector = function Selector(props) {
  ...
  return /*#__PURE__*/React.createElement(_web.View, {
    ...
    return /*#__PURE__*/React.createElement(_web.View, {
      key: option.key,
      className: (0, _classnames["default"])((_classNames = {}, (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-option"), true), (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-active"), activeParent === option.key), _classNames)),
      onTap: function onTap() {
        handleClickParentOption(option);
      }
    }, option.value, activeParent === option.key && index !== 0 ? /*#__PURE__*/React.createElement(_web.View, {
      className: "".concat(prefixCls, "-option-rounded_top")
    }, /*#__PURE__*/React.createElement(_web.View, {
      className: "".concat(prefixCls, "-option-rounded_top-circle")
    })) : null, activeParent === option.key ? /*#__PURE__*/React.createElement(_web.View, {
    ...
    return /*#__PURE__*/React.createElement(_web.View, {
      key: option.key,
      className: (0, _classnames["default"])((_classNames2 = {}, (0, _defineProperty2["default"])(_classNames2, "".concat(prefixCls, "-option"), true), (0, _defineProperty2["default"])(_classNames2, "".concat(prefixCls, "-active"), (value === null || value === void 0 ? void 0 : value[1]) === option.key), _classNames2)),
      onTap: function onTap() {
